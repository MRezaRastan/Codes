...
template<class Type>
void Foam::functionObjects::myTurbulenceFields::processField
(
...
Foam::functionObjects::myTurbulenceFields::nuTilda
(
    const Model& model
) const
{
...
template<class Model>
Foam::tmp<Foam::volScalarField>
Foam::functionObjects::myTurbulenceFields::L
(
    const Model& model
) const
{
...
template<class Model>
Foam::tmp<Foam::volScalarField>
Foam::functionObjects::myTurbulenceFields::I
(
    const Model& model
) const
{
