...
{
    defineTypeNameAndDebug(myTurbulenceFields, 0);
    addToRunTimeSelectionTable(functionObject, myTurbulenceFields, dictionary);
}
}

const Foam::Enum
<
    Foam::functionObjects::myTurbulenceFields::compressibleField
>
Foam::functionObjects::myTurbulenceFields::compressibleFieldNames_
({
...
const Foam::Enum
<
    Foam::functionObjects::myTurbulenceFields::incompressibleField
>
Foam::functionObjects::myTurbulenceFields::incompressibleFieldNames_
({
...
const Foam::word Foam::functionObjects::myTurbulenceFields::modelName_
(
...
void Foam::functionObjects::myTurbulenceFields::initialise()
{
...
bool Foam::functionObjects::myTurbulenceFields::compressible()
{
...
Foam::functionObjects::myTurbulenceFields::myTurbulenceFields
(
    const word& name,
    const Time& runTime,
...
bool Foam::functionObjects::myTurbulenceFields::read(const dictionary& dict)
{
...
bool Foam::functionObjects::myTurbulenceFields::execute()
{
    if (!initialised_)
    {
        initialise();
...
bool Foam::functionObjects::myTurbulenceFields::write()
{
    for (const word& f : fieldSet_)
    {
        const word localName(IOobject::scopedName(prefix_, f));
